...
const HeroBanner = () => {
    ...
    return (
        <div
            id="hero"
            className="w-full min-h-[100vh] relative bg-[#111111] overflow-hidden"
        >
            ...
            <Wrapper>
                ...
                >
                    <a href="mailto:sankalpbsalve@gmail.com">
                        <div className="flex items-center gap-[6px]">
                            <div className="w-[35px] h-[35px] rounded-full bg-[#252525] flex justify-center items-center">
                                <img src={gmailIcon} alt="" className="w-[18px]" />
                            </div>
                            <div>sankalpbsalve@gmail.com</div>
                        </div>
                    </a>
                    <ul className="flex 2xl:text-[20px]">
                        <li
                            ...
                            onClick={() => {
                                window.open("https://www.linkedin.com/in/sankalp13/","_blank")
                            }}
                        >
                            LinkedIn
                        </li>
                ...
                >
                    <h1 className="text-[50px] md:text-[120px] 2xl:text-[189px] leading-[50px] md:leading-[125px]  2xl:leading-[192px] font-oswald uppercase">
                        ...
                        <span className="text-gredient">Web Developer</span>
                    </h1>
                </motion.div>
                {/* BIG HEADING END */}
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Sankalp Salve</span>
                    </div>
                    <div className="max-w-[510px]">
                    I develop user interfaces, web applications and automating software
                     processes using tools like Docker and Jenkins. My expertise in both 
                     areas allows me to efficiently deliver high-quality software.
                    </div>
                </motion.div>
                {/* INTRO END */}
                ...
                >
                    ...
                    {/* Resume BUTTON START */}
                    <div
                        className="md:ml-80 md:mb-36 mx-auto md:w-[140px] md:h-[140px] w-[280px] h-[280px] rounded-full bg-white/[0.7] hover:bg-white/[0.9] hover:scale-125 ease-in duration-300 flex flex-col justify-center items-center gap-2 backdrop-blur-sm cursor-pointer transition-transform scale-[0.65] md:scale-100 active:scale-[0.55] md:active:scale-90"
                        onClick={() => {
                            window.open("https://drive.google.com/file/d/16kqOl9JYxRLTwc84lh9kblq8YB0-bBEt/view?usp=share_link", "_black")
                        }}
                    >
                        <img
                            ...
                            className="w-[15px]"
                        />
                        <div className="text-black">My Resume</div>
                    </div>
                    {/* Resume BUTTON END */}
                </motion.div>
                {/* PERSON BLOCK END */}
